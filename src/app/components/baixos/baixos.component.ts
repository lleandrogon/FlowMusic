...
export class BaixosComponent {
  produtos: Produto[] = [
    ...
    new Produto("Baixo Fender MEX Player Jazz Bass Plus Blue", 'https://static.wixstatic.com/media/21feb7_8d9778a32e344963ad6f327668aadd3b~mv2.jpg/v1/fill/w_480,h_480,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/21feb7_8d9778a32e344963ad6f327668aadd3b~mv2.jpg', 8000, ''),

    new Produto("Baixo Sterling Music Man Sub 5 cordas Ruby", 'https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcR-Uv7pXcL9l6sBffGAc5Lk5OuL_a4RN55zWemsS0QhpNPNaJngZmjTUGm_1n-pMTYg4upYZKRUB1MQAsGNumq43KWixyk6LrWePM4L37JFlvF3KRYh0Sbh&usqp=CAE', 7000, ''),

    new Produto("Baixo Fender Vintera Precision Bass 50s - Red", 'https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcR_6jnLO11C_epLLT_woFNqMPtioybF3ijW9seM_vEGALHBuTieIGGIR2qf2o1x1eMFt1oeErrEEVIE1IW_VMzScoiMIyNEpg0P-noDX58&usqp=CAE', 4600, ''),
    ...
    new Produto("Baixo Ibanez Gsr 205B WNF 5 Cordas Walnut", 'https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSN1vGlEjtAh-JN04zHcr41XrAgofy5YwZIMLt6zGeaLe5zpzD_VdEoomBgA3MAG3V3K2zj_vZCLlVtRUpDe7oawocZB2SCX5RolX9mtp8jwRs_bbV2Ut5v&usqp=CAE', 2700, ''),
    ...
    new Produto("Baixo Cort Action Act Bass Plus Preto 4 Cordas", 'https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcT-G2YVSDNEm3rXw997PiAXiEauYRS-m4z6j-ovtpoJ2iGaLFjHF84t2qdR7KlcAsRP6sPOL9fTNgj5alCW3j6pj2Fh3Z7pEkBe9tHZrzRq9mEcmjS7-P7i&usqp=CAE', 1700, ''),
    ...
    new Produto("Baixo Memphis Mb50 Branco Olympic White", 'https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcTvY9R_gT2OQ_LcWijAMi0a_xugTSeg6oJ7LzWn96-vCFEoYu-J8fpfyjggOT_9Nh5hRH2PR_N2UXmOzk1maiXXQnS8QeVby6_EVKeTzlc&usqp=CAE', 950, ''),
  ]
