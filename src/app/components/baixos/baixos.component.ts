...
export class BaixosComponent {
  produtos: Produto[] = [
    ...
    new Produto("Baixo Fender MEX Player Series Jazz Bass Plus Blue", 'https://static.wixstatic.com/media/21feb7_8d9778a32e344963ad6f327668aadd3b~mv2.jpg/v1/fill/w_480,h_480,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/21feb7_8d9778a32e344963ad6f327668aadd3b~mv2.jpg', 8000, ''),
    ...
    new Produto("Baixo Cort Action Act Bass Plus Preto 4 Corda Ativo", 'https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcT-G2YVSDNEm3rXw997PiAXiEauYRS-m4z6j-ovtpoJ2iGaLFjHF84t2qdR7KlcAsRP6sPOL9fTNgj5alCW3j6pj2Fh3Z7pEkBe9tHZrzRq9mEcmjS7-P7i&usqp=CAE', 1700, ''),
